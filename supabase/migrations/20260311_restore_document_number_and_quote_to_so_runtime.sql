-- Restore deterministic document numbering function and canonical quote->sales-order conversion.
...
set client_reference_number = coalesce(q.client_reference_number, q.customer_reference, e.client_reference_number)
from crm.enquiries e
where q.enquiry_id = e.id
  and q.client_reference_number is null;
